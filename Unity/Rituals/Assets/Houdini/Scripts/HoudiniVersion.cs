...
public struct HoudiniVersion
{
	...
	public const int HOUDINI_BUILD			= 347;
	...
	public const string HAPI_SERVER			= "/Library/Frameworks/Houdini.framework/Versions/15.0.347/Resources/bin/" + "HARS";
	#if UNITY_EDITOR_64
		public const string HAPI_LIBRARY	= "/Library/Frameworks/Houdini.framework/Versions/15.0.347/Libraries/" + "libHARC.dylib";
	#else
		public const string HAPI_LIBRARY	= "/Library/Frameworks/Houdini.framework/Versions/15.0.347/Libraries/" + "libHARC32.dylib";
	#endif // UNITY_EDITOR_64
